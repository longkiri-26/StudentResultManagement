...
public class insertNewResult extends javax.swing.JFrame {
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        String AAD=jTextField3.getText();
        String CN=jTextField4.getText();
        String CD=jTextField5.getText();
        ...
        try{
            ...
            if(rs.next())
            {
                st.executeUpdate("insert into result(rollNo,OS,AAD,CN,CD,DBMS) values('"+rollNo+"','"+OS+"','"+AAD+"','"+CN+"','"+CD+"','"+DBMS+"')");
